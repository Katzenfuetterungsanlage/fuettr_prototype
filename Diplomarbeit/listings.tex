...
\lstdefinelanguage{CSS}{
  keywords={body, title, text, bigger-h1, important, media, import, screen, switch, slider, table-hover,},
  ndkeywords={background-image, margin, padding, font:, weight, display:, border:, size, white, space, min, transition-property, transition-duration, transition-timing-function, background-color:, border-radius:, border-bottom:, color:, max-width:, max-width, margin-top, margin-bottom, font-size:, input, :before, :checked, :focus, position:, cursor:, top:, left:, right:, bottom:, -webkit-transition:, transition:, content:, height:, width:, box-shadow:, -webkit-transform:, -ms-transform:, transform:},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
...
\lstdefinestyle{css} {
  % general style
  backgroundcolor=\color{editorGray},   		% choose the background color
...
\lstdefinestyle{C}{ %define c style
  ...
  backgroundcolor=\color{editorGray},   	% choose the background color; you must add \usepackage{color} or \usepackage{xcolor}
  basicstyle=\footnotesize\ttfamily,        		% the size of the fonts that are used for the code
  breakatwhitespace=false,         		% sets if automatic breaks should only happen at whitespace
  breaklines=true,                 			% sets automatic line breaking
  captionpos=b,                    			% sets the caption-position to bottom
