...
In diesen Teil meiner Diplomarbeit werden Berechnung von wichtigen bzw. Problemstellen durchgeführt:

\subsection{Berechnung der Klemme}

Gewählte Presskraft = 10N \\
Die Maße der Fläche auf den die Klemme drückt = 4mm x 20mm x 100mm
Diese Kraft wurde so hoch dimensioniert weil sie beim Klemmen der Verpackung Fleischstücken dazwischen befinden können. 
