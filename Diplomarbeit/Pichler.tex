...
\item Zu guter Letzt die Geschmacksprobe. Dies wurde bewiesen indem die Katze die ganze Schüssel fraß. Siehe Abbildung: \ref{Futter_Ende_2}.
...
\vspace{-20pt}
  \begin{center}
    \includegraphics[width=0.3\textwidth]{Bilder/Simulation/Federauslenkung_Simulation}
  \end{center}
