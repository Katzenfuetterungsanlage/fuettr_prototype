...
\\ \\ 
Als erstes muss eine Verbindung mit der Datenbank aufgebaut werden.
...
Danach muss die Collection, in der gearbeitet werden soll, angelegt werden. Das ist mit der folgenden Methode möglich:
\begin{lstlisting}[style=JavaStyle]
