...
\vspace{-20pt}
  ...
  \vspace{-10pt}
\end{wrapfigure}   
In der Klasse \textbf{SystemInfo} werden dem Benutzer wichtige Informationen über seine Anlage angezeigt. Das GUI Fenster ist ein Informationsfenster. Das Fenster blockiert den EDT, an der Stelle an der es geöffnet wird, bis es geschlossen wird.

\vspace{10pt}

seriennummer vom server holen

\vspace{10pt}

ip adresse von server holen

\vspace{10pt}

version von datenbank

\vspace{10pt}

interner rechner vorgegeben - datenbank

\vspace{10pt}

wlan status - datenbank
