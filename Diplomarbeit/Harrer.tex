...
2 Stufen:
	Auf updated prüfen (versionsnummer wird verglichen)
	Wenn verhanden dann update starten möglich

Die Updates werden mit git pull geholt

nach update wird der raspberry neu gestartet
