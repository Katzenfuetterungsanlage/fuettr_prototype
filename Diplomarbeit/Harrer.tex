...
neueste version nicht untersützt
\\ ältere version verwendet 2.14.2
\subsection{Probleme mit pi4j -> Snapshotversion verwendet - ansonsten werden pins nicht erkannt}
snpashot wird verwendet
sonst werden pins nicht gefunden
\\ eventuell überprüfen ob die beta verwendet werden kann
\subsection{GUI auf "Touchscreen-Design" abändern}
jetzige gui nicht optimal für touch
\\ abändern für leichtere Bedienung
\subsection{Besser Benutzerverwaltung - Mehrere Benutzer anlegen}
möglichkeit implementieren mehr als einen benutzer anzulegen
\\ benutzer wird mit profil auf einem server gespeichert
\\ auf mehreren anlagen verwendbar
\subsection{Selbst erstellbare Vorlagen in denen Zeiten gespeichert werden}
profil mit zeiten erstellbar
\\ zb auf neuer anlage verwendbar wenn der gleiche benutzer verwendet wird
