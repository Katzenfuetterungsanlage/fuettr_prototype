...
\subsubsection{\ac{DBMS}}
Ein Datenbankmanagementsystem verwaltet eine oder mehrere Datenbanken. Mehrere Datenbanken werden dabei benötigt, wenn mehrere Anwendungen oder Programme jeweils eine eigene Datenbank brauchen. Ein Beispiel für ein \ac{DBMS} ist Mongodb.
...
\subsubsection{\ac{JSON}-Object} \label{subsubsec:Array}
...
\subsubsection{\ac{GUI} auf "Touchscreen-Design\grqq{} abändern}
