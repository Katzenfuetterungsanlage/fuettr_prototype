...
\\ Dieses Problem wurde mit dem Verwenden von der \ac{pi4j} Version 1.2 Snapshot gelöst. Mit der Snapshotversion werden nun alle Pins gefunden. Das Problem an der Snapshotversion ist, dass diese noch in der Entwicklung ist und somit noch Fehler enthalten sein können. Der Nachteil der Snapshotversion ist somit, dass sie noch in der Entwicklung ist und Fehler enthalten kann.
