...
Zur Überprüfung, ob dieser Wert angenommen werden kann, muss die Spannung am Optokoppler neu gerechnet und überprüft werden, ob die Spannung zwischen der maximal zulässige und der normalen Spannung ist.
\begin{center}
...
\item Der externen Spannungsversorgung von 5V\\
\end{itemize}
\textbf{Genereller Ablauf:}
\begin{enumerate}
\item Wenn der Sensor eine Reflektor-Fläche vor sich erkennt, schaltet der Phototransistor im Sensor durch.
\item Der durchgeschaltete Phototransistor, ermöglicht einen Stromfluss von der Spannungsquelle in den Optokoppler.
\item Dadurch schaltet der interne Phototransistor des Optokopplers durch.
\item Der durchgeschaltete Phototransistor, ermöglicht einen Stromfluss von einem der 3,3V-Pins in einen der GPIO-Pins des Raspberrys.
...
Zur Überprüfung, ob dieser Wert angenommen werden kann, muss die Spannung am Optokoppler  neu gerechnet werden und überprüft werden, ob die Spannung geringer als die maximal zulässige Spannung ist.
\begin{center}
