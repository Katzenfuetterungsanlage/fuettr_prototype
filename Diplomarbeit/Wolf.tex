...
\includegraphics[width=10cm]{Bilder/Bauteile/Lüfter}
\caption{Lüfter}
\label{Lüfter}
...
Ein PWM-Signal das mit diesem Programm generiert wird schaut  wie in \label{PWM} aus. Der Duty Cycle variiert jedoch je nach Motor und muss noch in der Praxis angepasst werden
\begin{figure}[H] 
\begin{center}
